"""
This multigrid solver is build from multigrid/rectangleMG.py and implements
...
class VarCoeffCCMG2dRect(MG.CellCenterMG2dRect):
    """
    ...
    def __init__(self, nx, ny, xmin=0.0, xmax=1.0, ymin=0.0, ymax=1.0,
        ...
        MG.CellCenterMG2dRect.__init__(self, nx, ny, ng=1,
